...
public class Employee {
	...
	public Employee(String email, String phone, String departmentTitle,  String jobName,  int salary) {
		this.email = email;
		this.phone =phone;
	...
	public Employee(int empId, String empName,String empNo,String email, String phone, String departmentTitle,  String jobName,  int salary) {
		this(email,phone, departmentTitle,jobName, salary);
		this.empId = empId;
